...
var iNettuts = {
    ...
    init : function () {
        ...
        $(this.settings.widgetSelector,$(this.settings.columns)).each(function (i) {
            if(!this.id) {
    ...
    getWidgetSettings : function (id) {
        ...
        return (id && settings.widgetIndividual[id]) ? $.extend({},settings.widgetDefault,settings.widgetIndividual[id]) : $.extend({},settings.widgetDefault);
    },


    setWidgetSettings: function (id,newSettings) {
        var $ = this.jQuery,
        settings = this.settings;
        settings.widgetIndividual[id] = $.extend({},newSettings);
    },
    ...
    addWidgetControls : function () {
        ...
        $(settings.widgetSelector, $(settings.columns)).each(function () {
            ...
            $(settings.handleSelector+" .remove", this).remove('.remove');
        ...
        $(settings.handleSelector+" .edit", this).remove('.edit');     
        $(".edit-box", this).remove('.edit-box');       
	    ...
	    $(settings.handleSelector+" .collapse", this).remove('.collapse');	
    ...
    makeSortable : function () {
        ...
        var selettore = settings.columns+' > li'+settings.widgetSelector

        if ( notSortable ) {
            selettore +=':not('+notSortable+')';             
        } 

        $sortableItems = $(selettore);  

        $(notSortable).find(settings.handleSelector).css({
            cursor: 'pointer'
        }).unbind();
        ...
        if ( editable ) {
            $(settings.columns).sortable( "option", "disabled", false ); 
        } else {
            $(settings.columns).sortable( "option", "disabled", true ); 
        }
